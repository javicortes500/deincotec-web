...
/**
 * Valida y formatea campos monetarios (permite números con separador de miles y decimales)
 */
export function validateCurrencyField(input) {
  ...
  // Evitar múltiples puntos o comas consecutivos
  ...
  if (value.length > 0) {
    // Convertir a número para validar (reemplazando coma por punto)
