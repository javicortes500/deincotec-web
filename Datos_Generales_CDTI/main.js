...
function loadFormData(data) {
    ...
    console.log('📥 Cargando datos del formulario...', data);
...
function initializeMainApp() {
    ...
    // Limpiar datos extraños DESPUÉS de que todo esté cargado (solo al inicio)
    setTimeout(() => {
        console.log('Limpieza inicial de campos');
        limpiarCamposIniciales();
    }, 1000);
    
    // Una segunda limpieza solo si es necesario
    setTimeout(() => {
        console.log('Segunda limpieza de campos (solo basura conocida)');
        limpiarCamposIniciales();
    }, 2000);
